...
namespace WindowsPhone.Client
{
    ...
    public sealed partial class App
    {
        ...
        public App()
        {
            ...
            nav.Configure(ViewModelLocator.SelectTestKey, typeof(SelectTest));
            nav.Configure(ViewModelLocator.TakeTestKey, typeof(TakeTest));
            nav.Configure(ViewModelLocator.ShowResultKey, typeof(ShowResult));
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if (rootFrame.Content == null)
            {
                ...
                // parameter
                if (!rootFrame.Navigate(typeof(SelectTest), e.Arguments))
                {
